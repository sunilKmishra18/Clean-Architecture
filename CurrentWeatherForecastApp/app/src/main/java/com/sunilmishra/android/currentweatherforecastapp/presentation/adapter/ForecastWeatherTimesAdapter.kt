package com.sunilmishra.android.currentweatherforecastapp.presentation.adapter
...
class ForecastWeatherTimesAdapter(private val context: Context) : RecyclerView.Adapter<ForecastWeatherTimesAdapter.Holder>() {
